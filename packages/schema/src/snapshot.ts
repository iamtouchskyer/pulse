...
export const SnapshotSchema = z.object({
  ...
  top_referrers: z.array(ReferrerSchema).max(10),
  top_paths: z.array(PathStatSchema).max(10),
  recent_issues: z.array(RecentIssueSchema).max(30),
  recent_stargazers: z.array(z.string().nullable()).max(30),
});
